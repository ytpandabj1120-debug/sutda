...
function evaluateHand(cards) {
  ...
  // ------------------------------
  const specialHands = [
    { pair: [1, 2], name: '알리', rankValue: 79 },
    { pair: [1, 4], name: '독사', rankValue: 78 },
    { pair: [1, 9], name: '구삥', rankValue: 77 },
    { pair: [1, 10], name: '장삥', rankValue: 76 },
    { pair: [4, 10], name: '장사', rankValue: 75 },
    { pair: [4, 6], name: '세륙', rankValue: 74 },
  ];
